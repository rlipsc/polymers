...
task test, "Test compiling Polymers":
  when defined(windows):
    ...
    exec "nim c polymers/demos/particledemo.nim"
    exec "nim c polymers/demos/particlelife.nim"
    exec "nim c polymers/demos/spaceshooter.nim"
    ...
    exec "nim c polymers/demos/simplewebsite.nim"
    exec "nim c polymers/demos/modelsandtextures.nim"
